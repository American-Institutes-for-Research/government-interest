...
long.5b <- count(in.all, vars = c("wipo_field", "year"))
keep.5b <- long.5b[which(long.5b$wipo_field %in% top10), ]
...
g.5l <- ggplot(merged.keep5) + 
  ...
  scale_colour_manual(values=c(darkRed, cyan, darkGreen, darkPurple)) +

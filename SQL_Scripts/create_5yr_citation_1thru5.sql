...
-- patent_20171226.temp_updated_gi is the table with all the government interest and government assignee patents
drop table patent_20171226.temp_5yr_citations_by_cite_yr5;
create table patent_20171226.temp_5yr_citations_by_cite_yr5 as 
select * from (
...
(select distinct(patent_id) from patent_20171226.government_interest)) as a
...
drop table patent_20171226.temp_5yr_citations_yr5;
create table patent_20171226.temp_5yr_citations_yr5 as
...
patent_20171226.temp_5yr_citations_by_cite_yr5 group by cited_patent_id;


drop table patent_20171226.temp_5yr_citations_by_cite_yr4;
create table patent_20171226.temp_5yr_citations_by_cite_yr4 as 
select * from (
select b.cited_patent_id, p2.date as cited_patent_date, b.citing_patent_id,b.citing_patent_date, b.num_times_cited_by_us_patents from (
select a.cited_patent_id, a.citing_patent_id, p.date as citing_patent_date, p.num_times_cited_by_us_patents from (
select * from PatentsView_20170808.uspatentcitation  where cited_patent_id in 
...
drop table patent_20171226.temp_5yr_citations_yr4;
create table patent_20171226.temp_5yr_citations_yr4 as
...
patent_20171226.temp_5yr_citations_by_cite_yr4 group by cited_patent_id;

drop table patent_20171226.temp_5yr_citations_by_cite_yr3;
create table patent_20171226.temp_5yr_citations_by_cite_yr3 as 
select * from (
select b.cited_patent_id, p2.date as cited_patent_date, b.citing_patent_id,b.citing_patent_date, b.num_times_cited_by_us_patents from (
select a.cited_patent_id, a.citing_patent_id, p.date as citing_patent_date, p.num_times_cited_by_us_patents from (
select * from PatentsView_20170808.uspatentcitation  where cited_patent_id in 
...
drop table patent_20171226.temp_5yr_citations_yr3;
create table patent_20171226.temp_5yr_citations_yr3 as
...
patent_20171226.temp_5yr_citations_by_cite_yr3 group by cited_patent_id;

drop table patent_20171226.temp_5yr_citations_by_cite_yr2;
create table patent_20171226.temp_5yr_citations_by_cite_yr2 as 
select * from (
select b.cited_patent_id, p2.date as cited_patent_date, b.citing_patent_id,b.citing_patent_date, b.num_times_cited_by_us_patents from (
select a.cited_patent_id, a.citing_patent_id, p.date as citing_patent_date, p.num_times_cited_by_us_patents from (
select * from PatentsView_20170808.uspatentcitation  where cited_patent_id in 
...
drop table patent_20171226.temp_5yr_citations_yr2;
create table patent_20171226.temp_5yr_citations_yr2 as
...
patent_20171226.temp_5yr_citations_by_cite_yr2 group by cited_patent_id;


drop table patent_20171226.temp_5yr_citations_by_cite_yr1;
create table patent_20171226.temp_5yr_citations_by_cite_yr1 as 
select * from (
select b.cited_patent_id, p2.date as cited_patent_date, b.citing_patent_id,b.citing_patent_date, b.num_times_cited_by_us_patents from (
select a.cited_patent_id, a.citing_patent_id, p.date as citing_patent_date, p.num_times_cited_by_us_patents from (
select * from PatentsView_20170808.uspatentcitation  where cited_patent_id in 
...
drop table patent_20171226.temp_5yr_citations_yr1;
create table patent_20171226.temp_5yr_citations_yr1 as
...
patent_20171226.temp_5yr_citations_by_cite_yr1 group by cited_patent_id;

select * from patent_20171226.temp_5yr_citations_yr1;

select * from patent_20171226.temp_5yr_citations_yr2;

select * from patent_20171226.temp_5yr_citations_yr3;

select * from patent_20171226.temp_5yr_citations_yr4;

select * from patent_20171226.temp_5yr_citations_yr5;
